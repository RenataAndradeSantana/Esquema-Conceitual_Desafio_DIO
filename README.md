<h1 align="center: justify">
    Desafios DIO - Heineken - Esquema Conceitual Oficina Mecânica </h1>
...
<p style="text-align: justify;">Este projeto consiste no esquema conceitual para um sistema de controle e gerenciamento de execução de ordens de serviço em uma oficina mecânica. O sistema permitirá o registro de clientes, veículos, mecânicos e ordens de serviço, garantindo o acompanhamento detalhado dos serviços prestados.</p>
